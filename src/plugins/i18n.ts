...
const messages = {
  en: {
    ...
    remove_a_photo: "Remove a photo",
    phone_number: "Phone Number",
    account_status: "Account Status",
    created_at: "Created At",
    full_name_hint_text:
      "Your name can appear on the homepage, account details, and orders. You can update it at any time.",
    email_hint_text:
      "The email address is unique, it is used to log into the account into the system. It can't be changed.",
    phone_number_hint_text:
      "Your phone number is added to facilitate ordering. You can update it at any time.",
    save: "Save",
    cancel: "Cancel",
    image_preview: "Image Preview:",
    update_address_hint_text:
      "Please update the correct and clear address for us to easily deliver. Thank you guest!",
    city: "City / Province",
    district: "District",
    ward: "Ward",
    street: "Street",
    specific_address: "Specific Address (Optional)",
    change_password_hint_text:
      "Changing your password regularly is also essential if you use the same password for multiple services, as there is a chance that your password will be stolen when one of the services you are using is hacked.",
